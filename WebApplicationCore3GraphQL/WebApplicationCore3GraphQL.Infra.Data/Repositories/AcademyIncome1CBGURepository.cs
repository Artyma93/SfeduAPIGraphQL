...
namespace WebApplicationCore3GraphQL.Infra.Data.Repositories
{
    public class AcademyIncome1CBGURepository : IAcademyIncome1CBGURepository
    {
        ...
        public Task<IReadOnlyDictionary<int, AcademyIncome1CBGU>> GetAcademyIncome1CBGUsAsync(IReadOnlyCollection<int> academyIncome1CBGUIds, CancellationToken cancellationToken)
        {
